---
title: "Bridging the Gap: HtmlUnit-jsoup Integration"
date: 2025-07-10
---
...
ecosystem to HtmlUnit developers.

## The jsoup Ecosystem Advantage

While HtmlUnit provides browser simulation capabilities, the jsoup ecosystem offers something
equally valuable: a vast collection of tools, utilities, and extensions built around 
jsoup's elegant parsing API. This includes:
...
## Getting Started
Ready to add this capability to your HtmlUnit project? 
Head over to the [htmlunit-jsoup](https://github.com/HtmlUnit/htmlunit-jsoup) 
GitHub repository for complete installation instructions, usage examples, and the latest version information.
